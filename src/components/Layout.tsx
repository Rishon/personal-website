...
> = {
    ...
    "/contact": {
        ...
        description:
            "Contact Rishon Jaffe.",
        keywords:
            "contact Rishon Jaffe, software engineer contact",
        type: "website",
    },
    "/404": {
...
const RootLayout = ({children}: Readonly<{ children: React.ReactNode }>) => {
    ...
    return (
        <>
            ...
            <div
                className="page-panel fixed bottom-dock left-panel right-panel top-panel z-[2] flex flex-col overflow-hidden rounded-2xl max-md:rounded-none">
                <header className="mx-auto w-full max-w-column flex-shrink-0 px-4 pb-v-sm pt-v-md md:px-6">
                    <StatusBar/>
                </header>

                <main
                    className="mx-auto flex w-full min-h-0 max-w-column flex-1 flex-col overflow-hidden px-4 pb-v-md md:px-6">
                    {children}
                </main>
            </div>
