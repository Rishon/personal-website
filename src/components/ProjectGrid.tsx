                ...
                <span className="min-w-0 flex-1">
                  <span className="flex items-center gap-1.5">
                    ...
                    {project.isGithub ? (
                      ...
                      <LuArrowUpRight className="h-3 w-3 flex-shrink-0 text-ink-faint transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
                    )}
                  </span>
                  {!isOpen && (
