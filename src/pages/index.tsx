...
import { SiTypescript, SiDocker, SiKotlin } from "react-icons/si";
    ...
    <div className="flex min-h-0 flex-1 flex-col gap-v-md">
      ...
      <div className="max-w-prose flex-shrink-0 text-body">
        <WordSettle delay={0.7}>
          ...
          <Link href="https://glade.chat" target="_blank" className="font-medium text-ink underline decoration-accent-40 underline-offset-4 transition-colors hover:text-accent">
            Glade
          </Link>{" "}
          and{" "}
          <Link href="https://zeraph.app" target="_blank" className="font-medium text-ink underline decoration-accent-40 underline-offset-4 transition-colors hover:text-accent">
            Zeraph
          </Link>
          .
        </WordSettle>
